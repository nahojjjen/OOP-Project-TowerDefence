...
public class SlowTower extends Tower {
    ...
    public SlowTower(Vector2 pos){
        super(pos, img, 500, new TargetClosest(), 100);
    }

    @Override
    public Projectile createProjectile() {
        return new SlowDownBullet(getCenter(), PointCalculations.getVectorAngle(getPosition(),getTarget().getPosition()), getTarget(), 50, 5000);
    }
